 ...
 */
@Controller
public class PublishRITISWeatherDataController {
    ...
    private String topicName = "RITISWeatherTopic";
    
    
    @RequestMapping(value = "publishRITISWeather", method = RequestMethod.POST)
    public @ResponseBody String publishData(@RequestBody ODEAgentMessage odeAgentMessage) {
        logger.debug("~~~~~~~Received RITIS Weather message .");
        try {
