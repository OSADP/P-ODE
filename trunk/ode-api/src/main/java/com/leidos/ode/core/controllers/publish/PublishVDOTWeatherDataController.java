 ...
 */
@Controller
public class PublishVDOTWeatherDataController {
    ...
    private String topicName = "VDOTWeatherTopic";
    
    
    @RequestMapping(value = "publishVDOTWeather", method = RequestMethod.POST)
