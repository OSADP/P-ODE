 ...
 */
@Controller
public class PublishRITISSpdVolOccDataController {
    ...
    private String topicName = "RITISSpdVolOccTopic";
    
    
    @RequestMapping(value = "publishRITISSpdVolOcc", method = RequestMethod.POST)
    public @ResponseBody String publishData(@RequestBody ODEAgentMessage odeAgentMessage) {
        logger.debug("~~~~~~~Received RITIS Speed Vol Occ message .");
        try {
