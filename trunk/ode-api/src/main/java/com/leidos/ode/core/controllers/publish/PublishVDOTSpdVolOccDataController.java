 ...
 */
@Controller
public class PublishVDOTSpdVolOccDataController {
    ...
    private String topicName = "VDOTSpdVolOccTopic";
    
    
    @RequestMapping(value = "publishVDOTSpdVolOcc", method = RequestMethod.POST)
    public @ResponseBody String publishData(@RequestBody ODEAgentMessage odeAgentMessage) {
        logger.debug("~~~~~~~Received VDOT Speed Vol Occ message .");
        try {
