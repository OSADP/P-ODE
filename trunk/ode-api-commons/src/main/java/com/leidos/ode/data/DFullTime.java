...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "DFullTime", isSet = false )
    public class DFullTime implements IASN1PreparedElement {
	...
	private DMinute minute = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(DFullTime.class);
