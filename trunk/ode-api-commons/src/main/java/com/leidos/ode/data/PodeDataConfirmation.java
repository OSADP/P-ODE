...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PodeDataConfirmation", isSet = false )
    public class PodeDataConfirmation implements IASN1PreparedElement {
  ...
  @ASN1OctetString( name = "" )
	...
	private PodeDataDestination destination = null;
                
  
        @ASN1Element ( name = "hash", isOptional =  false , hasTag =  true, tag = 5 , hasDefaultValue =  false  )
	...
	private Sha256Hash hash = null;
        ...
        public PodeDataDestination getDestination () {
        ...
        public void setDestination (PodeDataDestination value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PodeDataConfirmation.class);
