...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PodeLogDataRequest", isSet = false )
    public class PodeLogDataRequest implements IASN1PreparedElement {
  ...
  @ASN1OctetString( name = "" )
	...
	private byte[] requestID = null;
        ...
        @ASN1Element ( name = "query", isOptional =  false , hasTag =  true, tag = 4 , hasDefaultValue =  false  )
    
	private PodeLogQuery query = null;
        ...
        public PodeLogQuery getQuery () {
            return this.query;
        }

        

        public void setQuery (PodeLogQuery value) {
            this.query = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PodeLogDataRequest.class);
