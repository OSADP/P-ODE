...
public class RDEData {
    ...
    private com.leidos.ode.core.rde.data.RDEMetadata rdeMetadata;
    ...
    @JsonCreator
    public RDEData(@JsonProperty("name") String name, @JsonProperty("metadata") com.leidos.ode.core.rde.data.RDEMetadata rdeMetadata) {
        this.name = name;
