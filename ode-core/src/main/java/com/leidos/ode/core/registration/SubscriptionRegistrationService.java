    ...
    RegistrationMessage registerSubscription(@RequestBody RegistrationMessage registrationRequest) {
        ...
        try {
            ...
            if (subRegistration.getType().getReplayData() != null) {
                ...
                logger.debug("Received Replay for Dates Start:"+subRegistration.getType().getReplayData().getStartTime().getYear().getValue()+"-"+
                                            subRegistration.getType().getReplayData().getStartTime().getMonth().getValue()+"-"+
                                            subRegistration.getType().getReplayData().getStartTime().getDay().getValue()+
                                "End: "+subRegistration.getType().getReplayData().getEndTIme().getYear().getValue()+"-"+
                                            subRegistration.getType().getReplayData().getEndTIme().getMonth().getValue()+"-"+
                                            subRegistration.getType().getReplayData().getEndTIme().getDay().getValue());
