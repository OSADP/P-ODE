...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PodeDataDistribution", isSet = false )
    public class PodeDataDistribution implements IASN1PreparedElement {
  ...
  @ASN1OctetString( name = "" )
	...
	private PodeDataRecord podeData = null;
        ...
        @ASN1Element ( name = "messageID", isOptional =  true , hasTag =  true, tag = 5 , hasDefaultValue =  false  )
	...
	private Sha256Hash messageID = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PodeDataDistribution.class);
