...
public enum ODEMessageType {
    ...
    VDOTBSM("VDOT", false, new byte[]{0x01,0x00,0x00,0x00}),
    ...
    SDCSpeed("VSD", false, new byte[]{0x07, 0x00, 0x00, 0x00}),
    INCIDENT("INCIDENT", false, new byte[]{0x08, 0x00, 0x00, 0x00}),
    VDOTIncident("VDOT", false, new byte[]{0x01, 0x00, 0x00, 0x00}),
    MockIncident("MOCK", false, new byte[]{0x09, 0x00, 0x00, 0x00}),
    RITISIncident("RITIS", false, new byte[]{0x02, 0x00, 0x00, 0x00});
