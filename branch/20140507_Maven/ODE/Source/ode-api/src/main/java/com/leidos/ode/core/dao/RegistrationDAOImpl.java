 ...
 */
public class RegistrationDAOImpl extends BasicDAO<RegistrationInformation, ObjectId> implements RegistrationDAO{

    public RegistrationDAOImpl(Mongo mongo, Morphia morphia) {
        super(mongo, morphia, "RegistrationInfo");
    }
